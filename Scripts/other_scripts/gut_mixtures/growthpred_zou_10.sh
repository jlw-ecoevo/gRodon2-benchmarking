...
GrowthPred_CONTAINER="ZOU10"
GrowthPred_DIR="Zou10_GrowthPred_MetagenomeMode"
NUCL_DIR="Assemblies"
RIBO_DIR="Assemblies"
...
grep "Predicted minimum generation time:" * | awk 'gsub(".results:Predicted minimum generation time:  ","\t")' | awk 'gsub(" hours.*","")' > ../growthpred_zou_10.tbl
grep "Nucleotide frequencies:" * | awk 'gsub("Nucleotide frequencies: ","")' | awk '{print $7+$11}' > ../zou_gc_10.txt
paste ../growthpred_zou_10.tbl ../zou_gc_10.txt > ../zou_gc_gorg_10.tbl
