...
GrowthPred_CONTAINER="GORG2"
GrowthPred_DIR="GORG10_GrowthPred_MetagenomeMode"
NUCL_DIR="Genes10plus"
RIBO_DIR="Genes10plus"
...
grep "Predicted minimum generation time:" * | awk 'gsub(".results:Predicted minimum generation time:  ","\t")' | awk 'gsub(" hours.*","")' > ../growthpred_gorg.tbl
grep "Nucleotide frequencies:" * | awk 'gsub("Nucleotide frequencies: ","")' | awk '{print $7+$11}' > ../gorg_gc.txt
paste ../growthpred_gorg.tbl ../gorg_gc.txt > ../growthpred_gc_gorg.tbl
