...
GrowthPred_CONTAINER="GP_GM"
GrowthPred_DIR="REFSEQ_GrowthPred_Genomes_MetagenomeMode"
...
grep "Predicted minimum generation time:" * | awk 'gsub(".results:Predicted minimum generation time:  ","\t")' | awk 'gsub(" hours.*","")' > ../growthpred_refseq_GM.tbl
grep "Nucleotide frequencies:" * | awk 'gsub("Nucleotide frequencies: ","")' | awk '{print $7+$11}' > ../gp_gc_GM.txt
paste ../growthpred_refseq_GM.tbl ../gp_gc_GM.txt > ../growthpred_gc_refseq_genomes_meta_GM.tbl
